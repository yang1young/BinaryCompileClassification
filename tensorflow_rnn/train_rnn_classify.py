...
def train_step(filepath,is_byte,need_replace_number):
    ...
    train_data,valid_data,test_data=data_helper.load_data(filepath,FLAGS.max_len,FLAGS.vocabulary_size,is_byte,need_replace_number)
