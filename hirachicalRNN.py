...
def model_structure():
    ...
    embedded_sequences = Embedding(output_dim=EMBEDDING_DIM, input_dim=MAX_NB_WORDS, input_length=MAX_SENT_LENGTH,trainable=True)(
        sentence_input)
...
if __name__ == "__main__":
    train_texts, train_blocks, train_labels = data_helper.prepare_dl_data(data_helper.small_sample_dir + 'data.dev')
    _, dev_blocks, dev_labels = data_helper.prepare_dl_data(data_helper.small_sample_dir + 'dev')
